...
template = "page.html"
+++
All phases of the project will be completed in C++. By default, the project skeleton is configured to use C++23. If you'd like to use newer versions of the C++ standard, you are free to do so, but make sure the features you're using are supported.
...
The project is configured to use C++23 by default. If you'd like to use other versions, you are free to do so, but if your workflow breaks we can only provide limited assistance.
